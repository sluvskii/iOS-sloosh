...
public struct VariableBlurView: View {
    ...
    public init(maxBlurRadius: CGFloat = 2, direction: VariableBlurRepresentable.BlurDirection = .blurredTopClearBottom, tintColor: Color = Color(UIColor.systemBackground), tintOpacity: Double = 1.0, style: UIBlurEffect.Style = .systemMaterial) {
